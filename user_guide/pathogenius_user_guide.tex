...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/login_screen.jpeg}
  \caption{The Pathogenius login screen with username/password fields and guest mode option.}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/registration_screen.jpeg}
  \caption{Account registration form with password strength indicator.}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/app_layout_overview.png}
  \caption{Main window showing the sidebar navigation and content area.}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/dashboard_screen.jpeg}
  \caption{Dashboard showing system resources, analysis summary, and recent analyses table.}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/wizard_step1.jpeg}
  \caption{File selection step of the three-step analysis wizard.}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/wizard_step2.png}
  \caption{Configuration step showing engine selection cards, analysis settings form, and FASTQ statistics banner.}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/wizard_step3.png}
  \caption{Review screen showing all selected settings before launching.}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/results_history.jpeg}
  \caption{Analysis history table showing completed, failed, and running analyses.}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/results_detail_overview.png}
  \caption{Pathogen cards, AI summary section, and chart containers for a completed analysis.}
\end{figure}
...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item \textbf{Metrics:} Abundance among classified reads (\%), Read count
...
\begin{itemize}[leftmargin=1.5em]
  \item Abundance among classified reads (\%)
  \item Abundance among total reads (\%)
  \item Read Count
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/charts_tab}
  \caption{Charts Tab — Treemap, Sunburst, Sankey, and Radar charts.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/charts_tab_comparative}
  \caption{Charts Tab — comparative view across top pathogens.}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/cloud_results.png}
  \caption{Cloud results list with download actions for registered users.}
\end{figure}
...
\begin{tabular}{ll}
  ...
  Actions       & \btn{Download} and \btn{Delete} buttons \\
  \bottomrule
\end{tabular}
\end{center}

Click \faDownload\ \btn{Download} to decrypt and store a cloud result locally. Click \faTrash\ \btn{Delete} to permanently remove a result from the cloud (local copies are not affected). Click \faSync\ \btn{Refresh} to update the list from Firebase.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/database_management.png}
  \caption{Default database card, custom database creation form, and database list.}
\end{figure}
...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item \textbf{Statistics:} Total genome count and index status (\textit{"Indexed \faCheck"} or \textit{"Not built"})
\end{itemize}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/settings_page.png}
  \caption{Settings page showing all configuration sections.}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/terminal_screen.png}
  \caption{Embedded terminal window for direct pipeline interaction.}
\end{figure}
...
\begin{tabular}{ll}
  ...
  Logout                & Click \faIcon{sign-out-alt}\ Logout at sidebar bottom \\
